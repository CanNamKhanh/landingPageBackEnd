...
exports.conversationService = {
    ...
    async sendMessageToAiService(userId, data) {
        const conversationId = await getOrCreateConversation(userId, prisma_1.ConversationType.AI);
    ...
    async sendMessageToAdminService(userId, data) {
        const conversationId = await getOrCreateConversation(userId, prisma_1.ConversationType.ADMIN);
    ...
    async adminReplyService(adminId, targetUserId, data) {
        const conversationId = await getOrCreateConversation(targetUserId, prisma_1.ConversationType.ADMIN);
        const message = await prisma_2.prisma.message.create({
            data: {
                conversationId,
                userId: adminId,
    ...
    async adminGetUserMessagesService(targetUserId, query) {
        return exports.conversationService.getMessagesService(targetUserId, prisma_1.ConversationType.ADMIN, query);
    },
};
