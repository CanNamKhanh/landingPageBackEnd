...
exports.adminReply =
  exports.adminGetUserMessages =
  exports.adminGetAllConversations =
  exports.sendMessageToAdmin =
  exports.getAdminMessages =
  exports.sendMessageToAi =
  exports.getAiMessages =
...
const getMyConversations = async (req, res) => {
  ...
  const conversations =
    await conversation_service_1.conversationService.getMyConversationsService(
      userId,
    );
  res.status(200).json({
    success: true,
...
const getAiMessages = async (req, res) => {
  ...
  const result =
    await conversation_service_1.conversationService.getMessagesService(
      userId,
...
const sendMessageToAi = async (req, res) => {
  ...
  const body = req.body;
  const userMessage =
    await conversation_service_1.conversationService.sendMessageToAiService(
      userId,
      body,
    );
  ...
  const aiMessage =
    await conversation_service_1.conversationService.saveAiReplyService(
...
const sendMessageToAdmin = async (req, res) => {
  ...
  const body = req.body;
  const message =
    await conversation_service_1.conversationService.sendMessageToAdminService(
      userId,
      body,
    );
  res.status(201).json({
...
const adminGetAllConversations = async (req, res) => {
  const conversations =
    await conversation_service_1.conversationService.adminGetAllConversationsService();
  res.status(200).json({
    success: true,
    data: { conversations },
  });
...
const adminGetUserMessages = async (req, res) => {
  ...
  const query = req.query;
  const result =
    await conversation_service_1.conversationService.adminGetUserMessagesService(
      targetUserId,
      query,
    );
  res.status(200).json({
...
const adminReply = async (req, res) => {
  ...
  const body = req.body;
  const message =
    await conversation_service_1.conversationService.adminReplyService(
      adminId,
      targetUserId,
      body,
    );
